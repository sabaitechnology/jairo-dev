...
<head>
	...
	<title>[Sabai Technology] Tools: <?php $tool=ucfirst($_REQUEST['tool']); echo $tool; ?></title>
	...
	<style type='text/css'>
		.tablemenu { 
			width: 100%; border: 1px transparent double 
		...
		#response { 
			...
			min-height: 480px; 
			margin-top: 4px; 
			box-shadow: .3px .3px .3px .3px inset; 
			background:#FFF; 
			padding: 4px; 
			overflow: auto; 
		}
...
<tr>
	<td colspan=2 id='header'>
		...
		<div class='title' id='SVPNstatus'>Sabai VPN</div><div class='version' id='subversion'>Accelerator</div>
	</td>
</tr>
<tr id='body'>
	<td id='navi'><script type='text/javascript'>navi()</script>
	</td>
	<td id='content'>
