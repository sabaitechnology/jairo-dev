...
//performs console tasks - replaced by util?
// var sys = require('sys')
...
exports.sed = function sed(file, args, destructive, needsSudo, callback){
...
// //defining temporary variables - these will probably need to be sent from front end
// var ip				="777.111.222.111";
// var ipaddress	= ip.replace(".", "\.", "gi");
// var ipregex		="[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}";

// sed("./test.conf", ["-r ","s/range.*" + ipregex + "/'range '" + ipaddress + "/g"], true, false, function(result){
